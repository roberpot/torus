...
#ifndef __TORUS_NSOCKET_H
#define __TORUS_NSOCKET_H
...
public:
    ...
    NSocket(socket_t s, ConnectionType connection_type = ConnectionType::CONNECTIONTYPE_CLIENT);
    virtual ~NSocket();
    ...
    /*
    * @brief Send all the packets queued.
    */
    void send_packets();
};
